		...
		<section class="me-4">
			...
			<form method="post" action="SubjectCreateExecute.action">
				<div class="col-12 mb-3">
					...
					<input type="text" class="form-control form-control-lg" id="subject-cd-input" name="cd" value="${param.cd}" placeholder="科目コードを入力してください" required>
				...
				<div class="col-12 mb-3">
					...
					<input type="text" class="form-control form-control-lg" id="subject-name-input" name="name" value="${param.name}" placeholder="科目名を入力してください" required>
				</div>
