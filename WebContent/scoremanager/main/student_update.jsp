			...
			<form method="post" action="StudentUpdateExecute.action">
				...
				<div class="row border mx-3 mb-3 py-3 px-2 rounded">
					<div class="col-12 mb-3">
						...
						<input type="text" class="form-control form-control-lg" id="ent-year-input" name="ent_year" value="${student.entYear}" hidden="hidden">
						${student.entYear}
					</div>

					<div class="col-12 mb-3">
						<label class="form-label" for="student-no-input">学生番号</label><br>
						<input type="text" class="form-control form-control-lg" id="student-no-input" name="student_no" value="${student.no}" hidden="hidden">
						${student.no}
					</div>

					<div class="col-12 mb-3">
						<label class="form-label" for="student-name-input">氏名</label>
						<input type="text" class="form-control form-control-lg" id="student-name-input" name="student_name" value="${student.name}" required>
					</div>
