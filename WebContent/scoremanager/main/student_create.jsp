      ...
      <form method="post" action="StudentCreateExecute.action">
        <div class="row border mx-3 mb-3 py-3 px-2 rounded">
          ...
          <div class="col-12 mb-3">
            ...
            <input type="text" class="form-control form-control-lg" id="student-no-input" name="student_no"
                   value="${param.student_no}" placeholder="学生番号を入力してください" required>
          ...
          <div class="col-12 mb-3">
            ...
            <input type="text" class="form-control form-control-lg" id="student-name-input" name="student_name"
                   value="${param.student_name}" placeholder="氏名を入力してください" required>
          </div>
          <div class="col-12 mb-3">
